  ...
  <div class="itc-convert-tool">
    <form class="itc-convert-tool__form form">
      <div class="form__group form__group--file">
        <label>&#9312; Add image files here (.jpg, .jpeg, .png, .webp only):</label>
        ...
        <input ref="images" type="file" name="file" accept=".jpg, .jpeg, .png, .webp" multiple @change="updateSelected"/>
      ...
      <article class="itc-convert-tool__result-item" v-for="item in tasks">
        <div class="itc-convert-tool__result-item-wrap">
          ...
          <div class="itc-convert-tool__result-item-body">
            ...
            <ITCButtonLink :href="item.result" :target="'_blank'" :download="item.fileNameAfter" :class='"itc-convert-tool__result-item-download"' :disabled="!item.complete">Download</ITCButtonLink>
          </div>
        </div>
      </article>
    </div>
