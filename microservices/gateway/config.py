...
SERVER_JPG_HOST = "{}-jpg".format(os.getenv("DOCKER_IMAGE_NAME", ""))
SERVER_JPG_PORT = os.getenv("SERVER_JPG_PORT", "")
SERVER_PNG_HOST = "{}-png".format(os.getenv("DOCKER_IMAGE_NAME", ""))
SERVER_PNG_PORT = os.getenv("SERVER_PNG_PORT", "")
SERVER_WEBP_HOST = "{}-webp".format(os.getenv("DOCKER_IMAGE_NAME", ""))
