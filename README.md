...
This app is about converting an image from a format (e g. png, jpg, webp) to another. This app runs on kubernetes with docker. It uses AWS EKS for app hosting, and circleci for integration and deployment. It is also suited for local purposes.
