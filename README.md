...
- Make sure this application works using Minikube (In Progress)
  - Currently working on establishing connection between local computer (localhost) and Minikube.
...
- Add emergency break instructions for the case after running of server
