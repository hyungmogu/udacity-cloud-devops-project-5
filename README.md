...
This app is about converting an image from a format (e g. png, jpg, webp) to another. This app uses AWS EKS for app hosting, and circleci for integration and deployment. This app is also suited for local purposes.
